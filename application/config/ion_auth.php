...
$config['tables']['groups']          = 'auth_roles';
$config['tables']['users_groups']    = 'auth_users_roles';
 ...
 */
$config['site_title']                 = "Hello World";       // Site Title, example.com
...
$config['message_start_delimiter'] = '<li>'; 	// Message start delimiter
$config['message_end_delimiter']   = '</li>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<li>';		// Error message start delimiter
$config['error_end_delimiter']     = '</li>';	// Error message end delimiter